...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = 'C:\Program Files\springsource\sts-3.0.0.RELEASE/plugins/org.eclim_2.2.3'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = 'C:\Program Files\springsource\sts-3.0.0.RELEASE'
  if has('win32unix')
